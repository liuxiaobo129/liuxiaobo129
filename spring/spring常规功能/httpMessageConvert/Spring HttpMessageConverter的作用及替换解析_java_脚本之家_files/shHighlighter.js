 ...
 */
//$(function(){
$('div.jb51code').each(function(index, element) {
    var el = $(element);
    el.append('<div class="codetool" id="codetool"><a href="javascript:;" class="selall" title="全选"></a><a href="javascript:;" class="copy" title="复制"></a><div class="code_n"></div></div>');
	...
	el.find('.selall').attr("title","全选");
	el.find('.copy').attr("title","复制"+jb51yy+"代码");
	}
...
//生成目录索引列表1
        function GenerateContentList() {
            ...
            for (var i = 0; i < jquery_h1_list.length; i++) {
                var go_to_top = '<p class="maodian"><a name="_label' + i + '">&nbsp;</a></p>';
                ...
                for (var j = 0; j < jquery_h2_list.length; j++) {
                    var go_to_top2 = '<p class="maodian"><a name="_lab2_' + i + '_' + j + '">&nbsp;</a></p>';
                    ...
                    for (var k = 0; k < jquery_h3_list.length; k++) {
                        var go_to_third_Content = '<p class="maodian"><a name="_label3_' + i + '_' + j + '_' + k + '">&nbsp;</a></p>';
