                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <table id="data" class="table table-bordered table-striped table-hover">
                                <thead>
                                <tr>
                                    <th colspan="11">基础信息</th>
                                    <th colspan="1">登录/注册信息</th>
                                    <th colspan="8">常用地址信息</th>
                                    <th colspan="5">常用联系人信息</th>
                                    <th colspan="4">银行解绑信息</th>
                                </tr>
                                <tr>
                                    <th>RowKey</th>
                                    <th>时间</th>
    ...
    $(function () {
        ...
        dataGrid = $("#data").DataTable({
            ...
            "columnDefs": [
                ...
                {
                    "render": function (data) {
                        return appDataConfig.getText(data, "deviceTypeEnumMap");
                    },
                    "targets": 5
                },
                {
                ...
                {
                    "render": function (data, type, row) {
                        return appDataConfig.getText(data, "registLoginEnumMap");
                    },
                    "targets": 11
                },
                {
                    "render": function (data, type, row) {
                        return appDataConfig.getText(data, "channelEnumMap");
                    },
                    "targets": 12
                },
                {
                    "render": function (data, type, row) {
                        if ($.trim(row['opType']).indexOf("address") === -1) {
                            return '';
                        }
                        return data;
                    },
                ...
                {
                    "render": function (data, type, row) {
                        if ($.trim(row['opType']).indexOf("contact") === -1) {
                            return '';
                        }
                        return data;
                    },
                ...
                {
                    "render": function (data, type, row) {
                        return appDataConfig.getText(data, "bankCardTypeEnumMap");
                    },
                    "targets": 25
                },
                {
